...
namespace MATA_game
{
    public class HealthBar
    {
       ...
       public void LoadContent(ContentManager content)
        {
            healthTexture = content.Load<Texture2D>("Health/Health");
            healthBar = content.Load<Texture2D>("Health/HealthBar");
            changingHealth = content.Load<Texture2D>("Health/HealthChanging");
        }
